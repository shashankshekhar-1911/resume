  ...
  employment: [
    {
      ...
      achievements: [
        ...
        "(Margin Engineering) Shipped the **Insights Delivery Orchestration System**, automating a high-touch, 5-function satellite analytics delivery workflow; drove **3x operational throughput**, **5%+ uplift in project-level gross margin**, and **50% reduction in time-to-value** — expanding delivery capacity without proportional headcount growth",
  ...
  employment: [
    {
      ...
      achievements: [
        ...
        "(Internal Platform) Shipped the **Insights Delivery Orchestration System (IDOS)** — an automation layer collapsing a 5-function, high-touch satellite analytics delivery workflow into a near-touchless pipeline with human judgement checkpoints; delivered **3x throughput**, **5%+ project gross margin improvement**, and **50% faster time-to-value**",
  ...
  employment: [
    {
      ...
      achievements: [
        ...
        "(Workflow Optimisation) Built an in-house GTM-enablement tool unifying customer data across Salesforce, CS files and product configuration, and automating high-touch workflows (onboarding) to self-serve; reduced **setup time from 2 weeks to <1 day** and equipped CSMs with 360° details (usage, NPS) to improve efficacy",
        "(Delivery Automation) Designed and shipped the **Insights Delivery Orchestration System**, converting a high-touch, 5-function satellite analytics pipeline into a near-fully-automated workflow with human review gates; achieved **3x throughput uplift**, **5%+ project gross margin improvement**, and **50% faster time-to-value**",
      ],
    },
    {
      title: "Co-Founder / CEO (Product)",
  ...
  employment: [
    {
      ...
      achievements: [
        ...
        "(Delivery Engineering) Architected the **Insights Delivery Orchestration System (IDOS)**, replacing a high-touch, 5-function satellite analytics pipeline (CSM, PM, GIS, Data Science, etc.) with a near-fully-automated orchestration layer and human-in-the-loop review gates; drove **3x throughput uplift**, **5%+ project-level gross margin improvement**, and **50% reduction in time-to-value** for enterprise customers"
      ],
    },
    {
      title: "Co-Founder / CEO (Product)",
