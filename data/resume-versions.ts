  ...
  employment: [
    {
      ...
      achievements: [
        ...
        "(Margin Engineering) Shipped the **Insights Delivery Orchestration System**, automating a high-touch, 5-function satellite analytics delivery workflow; drove **3x operational throughput**, **50%+ uplift in project-level gross margin**, and **25% reduction in time-to-value** — expanding delivery capacity without proportional headcount growth",
  ...
  employment: [
    {
      ...
      achievements: [
        ...
        "(Delivery Engineering) Architected the **Insights Delivery Orchestration System (IDOS)**, replacing a high-touch, 5-function satellite analytics pipeline (CSM, PM, GIS, Data Science, etc.) with a near-fully-automated orchestration layer and human-in-the-loop review gates; drove **3x throughput uplift**, **50%+ project-level gross margin improvement**, and **25% reduction in time-to-value** for enterprise customers"
      ],
    },
    {
      title: "Co-Founder / CEO (Product)",
