  ...
  employment: [
    {
      ...
      achievements: [
        ...
        "(Executive Projects) Led high-stakes cost optimisation exercise with a goal to **improve Gross Margin by 25%**. Directly contributed to satellite imagery cost reduction by optimising area of interest algorithm to detect no-vegetation areas, resulting in **$150K savings**",
